...
\bibitem{polybench} Yuki, T., 2014, January. Understanding polybench/c 3.2 kernels. In International workshop on Polyhedral Compilation Techniques (IMPACT) (pp. 1-5).

\bibitem{wasmi} wasmi. [Online]. Available: \url{https://github.com/paritytech/wasmi}. Accessed on Apr. 15, 2021.

\bibitem{krustlet} Krustlet. [Online]. Available: \url{https://github.com/deislabs/krustlet}. Accessed on Apr. 15, 2021.

\bibitem{k3s} k3s. [Online]. Available: \url{https://k3s.io/}. Accessed on Apr. 15, 2021.

\bibitem{flannel} flannel. [Online]. Available: \url{https://github.com/flannel-io/flannel}. Accessed on Apr. 15, 2021.

\bibitem{coredns} CoreDNS. [Online]. Available: \url{https://coredns.io/}. Accessed on Apr. 15, 2021.

\bibitem{traefik} Traefik. [Online]. Available: \url{https://github.com/traefik/traefik}. Accessed on Apr. 15, 2021.

\bibitem{go-gc} Go memory ballast: How I learnt to stop worrying and love the heap. [Online]. Available: \url{https://blog.twitch.tv/en/2019/04/10/go-memory-ballast-how-i-learnt-to-stop-worrying-and-love-the-heap-26c2462549a2/}. Accessed on Apr. 15, 2021.

\bibitem{tensorflow} TensorFlow. [Online]. Available: \url{https://www.tensorflow.org/}. Accessed on Apr. 15, 2021.

\bibitem{keras} Keras. [Online]. Available: \url{https://keras.io/}. Accessed on Apr. 15, 2021.

\bibitem{tf-wasm} Introducing the WebAssembly backend for TensorFlow.js. [Online]. Available: \url{https://blog.tensorflow.org/2020/03/introducing-webassembly-backend-for-tensorflow-js.html}. Accessed on Apr. 15, 2021.

\bibitem{onnx} ONNX. [Online]. Available: \url{https://onnx.ai/}. Accessed on Apr. 15, 2021.

\bibitem{tract} tract. [Online]. Available: \url{https://github.com/sonos/tract}. Accessed on Apr. 15, 2021.

\bibitem{k8s-exec} Get a Shell to a Running Container. [Online]. Available: \url{https://kubernetes.io/docs/tasks/debug-application-cluster/get-shell-running-container/}. Accessed on Apr. 15, 2021.

\bibitem{fedra-thesis} fedra-thesis. [Online]. Available: \url{https://github.com/jiayihu/fedra-thesis}. Accessed on Apr. 15, 2021.

\bibitem{wasmcloud} Wasmcloud. [Online]. Available: \url{https://wasmcloud.com/}. Accessed on Apr. 15, 2021.

\bibitem{bytecode-alliance} Bytecode Alliance. [Online]. Available: \url{https://bytecodealliance.org/}. Accessed on Apr. 15, 2021.

\bibitem{mozilla-lies-off} Mozilla is laying off 250 people and planning a ‘new focus’ on making money. [Online]. Available: \url{https://www.theverge.com/2020/8/11/21363424/mozilla-layoffs-quarter-staff-250-people-new-revenue-focus}. Accessed on Apr. 15, 2021.

\bibitem{wasm-bindgen} wasm-bindgen. [Online]. Available: \url{https://github.com/rustwasm/wasm-bindgen}. Accessed on Apr. 15, 2021.

\bibitem{aws-rust} Why AWS loves Rust, and how we’d like to help. [Online]. Available: \url{https://aws.amazon.com/blogs/opensource/why-aws-loves-rust-and-how-wed-like-to-help/}. Accessed on Apr. 15, 2021.

\bibitem{wasm-micro-runtime} wasm-micro-runtime. [Online]. Available: \url{https://github.com/bytecodealliance/wasm-micro-runtime}. Accessed on Apr. 15, 2021.

\bibitem{wasm-64} Embedded devices: i8/i16 and memory pages less than 64KiB. [Online]. Available: \url{https://github.com/WebAssembly/spec/issues/899}. Accessed on Apr. 15, 2021.

\bibitem{deislabs} Deis Labs. [Online]. Available: \url{https://deislabs.io/}. Accessed on Apr. 15, 2021.
